...
Linkedlist.prototype.__defineGetter__('head', function () {
	return this._head && this._head.data
})

Linkedlist.prototype.__defineGetter__('tail', function () {
	return this._tail && this._tail.data
})

Linkedlist.prototype.__defineGetter__('current', function () {
	return this._current && this._current.data
})

Linkedlist.prototype.__defineGetter__('length', function () {
	return this._length
})
...
Linkedlist.prototype.unshiftCurrent = function () {
...
Linkedlist.prototype.removeCurrent = function (data) {
	var current = this._current
	if (this._length === 0) {
		return
	}
...
Linkedlist.prototype.resetCursor = function () {
